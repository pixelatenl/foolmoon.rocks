      ...
      <div class="column">
        <section class="block">
            ...
            <div class="block__content content">
                ...
                <h2>Links</h2>
                <ul>
                    <li><a href="http://www.studio-cube.nl/">Studio CUBE</a></li>
                    <li><a href="http://www.cafeoudbrabant.nl/">Cafe Oud brabant (Great venue! + rehearsal studios)</a></li>
                    <li><a href="http://www.ingridsonly.nl/">IngridsOnly productions</a></li>
                    <li><a href="http://www.kevinscholtze.wordpress.com">Graphic Designer Kevin Scholtze (Album Cover Design: Little Do We Know)</a></li>
                    <li><a href="http://www.dagoosemusic.nl/">Dagoose Music</a></li>
                </ul>
            </div>
        </section>
    </div>
